...
extension Logger: Logging {
    ...
    private func sendLogMessage(with type: LogType, logMessage: String, _ file: String, _ function: String, _ line: UInt) {
        switch type {
        case .error:
            internalLogger.error(logMessage, file: file, function: function, line: Int(line))
        case .warning:
            internalLogger.warning(logMessage, file: file, function: function, line: Int(line))
        case .debug:
            internalLogger.debug(logMessage, file: file, function: function, line: Int(line))
        case .info:
